...
class ChestData:
    ...
    expected_batch_size: Optional[int] = None # Expected number of samples (for missing sample detection)
...
class ECGAnalysisResult:
    ...
    """
    filtered_signal: List[float]       # Signal after normalization, filtering, and baseline removal
